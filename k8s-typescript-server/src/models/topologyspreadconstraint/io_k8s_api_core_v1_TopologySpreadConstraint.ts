...
* @resourceType topologyspreadconstraint
...
/**
* Create a new Topologyspreadconstraint with default values
* @param data - Optional partial data to override defaults
* @returns A new io_k8s_api_core_v1_TopologySpreadConstraint instance with defaults applied
*/
