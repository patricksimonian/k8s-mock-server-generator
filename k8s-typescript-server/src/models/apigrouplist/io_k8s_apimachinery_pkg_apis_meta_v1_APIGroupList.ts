...
* @isArray
*/
groups: Array<{ versions: Array<{ groupVersion: string; version: string }>; apiVersion?: string; kind?: string; name: string; preferredVersion?: { groupVersion: string; version: string }; serverAddressByClientCIDRs?: Array<{ clientCIDR: string; serverAddress: string }> }>;
}
