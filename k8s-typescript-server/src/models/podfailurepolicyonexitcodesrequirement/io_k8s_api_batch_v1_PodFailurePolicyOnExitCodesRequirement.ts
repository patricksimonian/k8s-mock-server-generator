...
* @resourceType podfailurepolicyonexitcodesrequirement
* @kind Podfailurepolicyonexitcodesrequirement
*/
...
/**
* Create a new Podfailurepolicyonexitcodesrequirement with default values
* @param data - Optional partial data to override defaults
* @returns A new io_k8s_api_batch_v1_PodFailurePolicyOnExitCodesRequirement instance with defaults applied
*/
