...
* @isArray
*/
resources?: io_k8s_api_core_v1_ResourceHealth[];
/**
...
// Required imports
import { io_k8s_api_core_v1_ResourceHealth, createio_k8s_api_core_v1_ResourceHealth } from '../io.k8s.api.core.v1.ResourceHealth';
