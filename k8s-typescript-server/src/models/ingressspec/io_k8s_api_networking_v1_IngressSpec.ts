...
* @isArray
*/
rules?: Array<{ host?: string; http?: { paths: Array<{ pathType: 'Exact' | 'ImplementationSpecific' | 'Prefix'; backend: { service?: { port?: { name?: string; number?: number }; name: string }; resource?: { apiGroup?: string; kind: string; name: string } }; path?: string }> } }>;
/**
