...
* @isArray
*/
claims?: io_k8s_api_core_v1_ResourceClaim[];
/**
...
// Required imports
import { io_k8s_api_core_v1_ResourceClaim, createio_k8s_api_core_v1_ResourceClaim } from '../io.k8s.api.core.v1.ResourceClaim';
