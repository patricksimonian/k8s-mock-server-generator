...
* @references io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.ServiceReference
*/
service?: io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_ServiceReference;
/**
...
export function createio_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_WebhookClientConfig(data?: Partial<io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_WebhookClientConfig>): io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_WebhookClientConfig {
 return {
   ...
   service: data?.service !== undefined ? data.service : createio_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_ServiceReference(),
   url: data?.url !== undefined ? data.url : '',
 };
}
// Required imports
import { io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_ServiceReference, createio_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_ServiceReference } from '../servicereference/io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_ServiceReference';
