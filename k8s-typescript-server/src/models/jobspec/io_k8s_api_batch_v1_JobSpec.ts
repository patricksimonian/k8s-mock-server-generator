...
* @isObject
*/
template: { metadata?: { deletionTimestamp?: Date; generateName?: string; labels?: Record<string, any>; ownerReferences?: Array<{ controller?: boolean; kind: string; name: string; uid: string; apiVersion: string; blockOwnerDeletion?: boolean }>; creationTimestamp?: Date; name?: string; uid?: string; annotations?: Record<string, any>; managedFields?: Array<{ apiVersion?: string; fieldsType?: string; fieldsV1?: Record<string, any>; manager?: string; operation?: string; subresource?: string; time?: Date }>; namespace?: string; selfLink?: string; generation?: number; finalizers?: string[]; resourceVersion?: string; deletionGracePeriodSeconds?: number }; spec?: Record<string, any> };
}
