...
* @isArray
*/
resources: Array<{ storageVersionHash?: string; verbs: string[]; version?: string; categories?: string[]; group?: string; namespaced: boolean; singularName: string; kind: string; name: string; shortNames?: string[] }>;
/**
